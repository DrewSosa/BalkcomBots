...
class Forward:
    ...
    def __str__(self):
        print
        "drove " + str(self.total_dist) + " meters forwards"
...
class Turn:
    ...
    def __str__(self):
        print
        "Turned by " + str(self.turning_angle) + " radians"
...
class WallFollow:
    ...
    def act(self, meters):
        ...
        move_cmd.linear.x = compute_vel_from_dist(error)  # error? meters - driven so far #when to stop?
